# Image Classifier 
  ...
  *This is a Project of the Udacity Machine Learning Nanodegree*
...
```
git clone https://github.com/moritztng/ImageClassifier
```
...
* Train a new network on a data set with ```train.py```
  ...
  * Options:
    ...
    * Choose vgg architecture : ```python train.py data_dir --arch "vgg16"```
